...
export default function Menu() {
    return (
        <aside className={`${true ? "" : "-translate-x-full"} absolute flex top-0 left-0 z-40 w-screen h-dvh transition-transform lg:translate-x-0 lg:relative lg:h-full lg:w-auto`}>
